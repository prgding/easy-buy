        ...
        <div class='manage'>
            <form action='<%=request.getContextPath()%>/updateMsg' method='post'>
                <table class='form'>
                    ...
                    <%
						Tmessages tm = (Tmessages)request.getAttribute("msg");
                    %>

                    <tr>
                        <td class='field'>留言ID：</td>
                        <td><input type='text' class='text' name='msgId' value='<%=tm.getMsgId()%>' readonly='readonly' /></td>
                    </tr>
                    <tr>
                        <td class='field'>留言姓名：</td>
                        <td><input type='text' class='text' name='msgSender' value='<%=tm.getMsgSender()%>' /></td>
                    </tr>
                    <tr>
                        <td class='field'>留言内容：</td>
                        <td><input type='text' class='text' name='msgContent' value='<%=tm.getMsgContent()%>' /></td>
                    </tr>
                    <tr>
                        <td class='field'>回复内容：</td>
                        <td><textarea name='msgReplyContent'><%=tm.getMsgReplyContent()%></textarea></td>
                    </tr>
                    <tr>
                        <td></td>
